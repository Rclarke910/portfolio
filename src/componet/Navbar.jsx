...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300' >
        ...
        {/* Hamburger */}
        <div onClick= {handleClick} className='md:hidden ml-auto text-white z-10 '>
            {!nav ? <FaBars /> : <FaTimes />}
        </div>
        ...
        {/*mobile menu */}
          ...
          <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center'}>
                ...
                <li className='py-6 text-4xl'><Link to="work" smooth={true} duration={500} onClick={handleClick}>Projects</Link></li>
       ...
       <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
        <ul>
            ...
            href='https://www.linkedin.com/in/rashawn-clarke-445385235' target="_blank">
            Linkedin <FaLinkedin size={30} />
            </a>
            </li>
            <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]'>
            <a className='flex justify-between items-center w-full text-gray-300'
            href='https://github.com/Rclarke910' target="_blank">
            Github <FaGithub size={30} />
            </a>
            </li>
            <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#6fc2b0]'>
            <a className='flex justify-between items-center w-full text-gray-300'
            href='mailto:“rashawnclarke1998@gmail.com'>
